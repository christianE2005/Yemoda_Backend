...
from apps.core.views import (
    ...
    GithubDeleteRepoView,
    GithubChatCopilotStatusProxyView,
    GithubChatProxyView,
    GithubPushListView,
...
urlpatterns = [
    ...
    path("api/github/repos/<int:repo_id>/", GithubDeleteRepoView.as_view(), name="github-delete-repo"),
    ...
    path("api/github/branches/", GithubRepoBranchesView.as_view(), name="github-repo-branches"),
    path("api/github/commit/", GithubCommitFilesView.as_view(), name="github-commit-files"),
    path("api/chat/", GithubChatProxyView.as_view(), name="github-chat-proxy"),
    path("api/chat/copilot/status/", GithubChatCopilotStatusProxyView.as_view(), name="github-chat-copilot-status-proxy"),
    ...
    path("api/tasks/<int:task_id>/pull-requests/", TaskPullRequestsView.as_view(), name="task-pull-requests"),
    path("api/reviews/", PullRequestListView.as_view(), name="reviews-list"),
    path("api/reviews/pr/", PullRequestDetailView.as_view(), name="reviews-pr-detail"),
    path("api/reviews/pr/files/", PullRequestFilesView.as_view(), name="reviews-pr-files"),
    path("api/reviews/pr/review/", PullRequestReviewView.as_view(), name="reviews-pr-review"),
    path("api/reviews/pr/comment/", PullRequestCommentView.as_view(), name="reviews-pr-comment"),
