...
from apps.core.views import (
    ...
    ExternalConnectionCreateView,
    ExternalConnectionTestView,
    AzureImportWorkitemsView,
    HealthCheckView,
    LoginView,
    ProjectMembersView,
    ...
    TaskCommentViewSet,
    TaskHistoryView,
    TaskMatchFeedbackView,
    MatchesExportCSVView,
    PushMatchesForPushView,
    PushMatchesBulkFeedbackView,
    TaskPriorityViewSet,
    TaskStatusViewSet,
    TaskViewSet,
...
urlpatterns = [
    ...
    path("api/external-connections/", ExternalConnectionCreateView.as_view(), name="external-connections"),
    path("api/external-connections/test/", ExternalConnectionTestView.as_view(), name="external-connections-test"),
    path("api/projects/<int:project_id>/import-from-azure/", AzureImportWorkitemsView.as_view(), name="project-import-azure"),
    path("api/external-connections/azure/oauth/start/", AzureOAuthStartView.as_view(), name="azure-oauth-start"),
    path("api/external-connections/azure/oauth/callback/", AzureOAuthCallbackView.as_view(), name="azure-oauth-callback"),
    ...
    path("api/matches/<int:match_id>/feedback/", TaskMatchFeedbackView.as_view(), name="match-feedback"),
    path("api/matches/export/", MatchesExportCSVView.as_view(), name="matches-export"),
    path("api/pushes/<int:push_id>/matches/", PushMatchesForPushView.as_view(), name="push-matches"),
    path("api/pushes/<int:push_id>/matches/confirm/", PushMatchesBulkFeedbackView.as_view(), name="push-matches-confirm"),
